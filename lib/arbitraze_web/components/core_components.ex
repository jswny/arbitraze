defmodule ArbitrazeWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    #   Gettext.dngettext(ArbitrazeWeb.Gettext, "errors", msg, msg, count, opts)
    # else
    #   Gettext.dgettext(ArbitrazeWeb.Gettext, "errors", msg, opts)
    # end
